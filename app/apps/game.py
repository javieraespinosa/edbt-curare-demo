...
QUESTIONS = [
    ...
    'Q4. Which is the release where the attribute UpVote from Users is most evenly distributed?',
    'Q5. Which is/are the attribute(s) useful to identify the most trendy topic addressed in the release?',
    'Q6. Which attributes can be used as sharding keys to fragment releases using a hash based strategy',
]
